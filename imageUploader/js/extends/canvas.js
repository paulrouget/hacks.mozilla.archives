(function(){
 ...
 CanvasRenderingContext2D.prototype.poster = function(text) {
   ...
   this.scale((this.width - 2 * size) / this.width, (this.width - 2 * size) / this.width);
   this.drawImage(this.canvas, 0, 0);
   this.strokeRect(0, 0, this.canvas.width, this.canvas.height);
   this.restore();
   */
   ...
   var border = 5;
   this.strokeRect(size - border, size - border,
                   this.width - (size * 2) + 2 * border,
                   this.height - (size * 3) + 2 * border);
